...
def construct_four_state_chain():
    ...
    rates = [('O', 'C', 'k2', 'k1'), ('I', 'IC', 'k1', 'k2'), ('IC', 'I',
                                                               'k1', 'k2'), ('O', 'I', 'k3', 'k4'), ('C', 'IC', 'k3', 'k4')]
...
class TestMarkovChain(unittest.TestCase):
    ...
    def test_SimulateStepProtocol(self):
        ...
        def M10_get_rates(voltage: float, params: list):
            params = (8.53183002138620944e-03, 8.31760044455376601e-02, 1.26287052202195688e-02, 1.03628499834739776e-07, 2.70276339808042609e-01, 1.58000446046794897e-02,
                      7.66699486356391818e-02, 2.24575000694940963e-02, 1.49033896782688496e-01, 2.43156986537036227e-02, 5.58072076984100361e-04, 4.06619125485430874e-02)
            # Now get the waiting times and embedded MC
